...
export 'package:rehearsal_app/core/auth/auth_provider.dart'
    show
...
export 'package:rehearsal_app/features/user/controller/user_provider.dart'
    show
...
export 'package:rehearsal_app/core/settings/settings_provider.dart'
    show
...
export 'package:rehearsal_app/core/providers/repository_providers.dart'
    show
        ...
        projectMembersRepositoryProvider, // Provider<ProjectMembersRepository> - Project members data access
...
export 'package:rehearsal_app/features/availability/controller/availability_provider.dart'
    show
        availabilityControllerProvider; // NotifierProvider<AvailabilityController, AvailabilityState> - Availability state

/// Calendar functionality
export 'package:rehearsal_app/features/calendar/providers/calendar_providers.dart'
    show
...
/// Navigation
export 'package:rehearsal_app/core/navigation/app_shell.dart'
    show navigationIndexProvider; // StateProvider<int> - Bottom nav bar index

/// Routing
export 'package:rehearsal_app/core/router/auth_router.dart'
    show routerProvider; // Provider<GoRouter> - Application router
...
export 'package:rehearsal_app/features/projects/presentation/projects_page.dart'
    show projectsProvider; // StateProvider<List<Project>> - Projects list

/// Calendar page providers
export 'package:rehearsal_app/features/calendar/presentation/calendar_page.dart'
    show
